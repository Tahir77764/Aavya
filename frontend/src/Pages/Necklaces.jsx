...
const Necklaces = () => {
    ...
    useEffect(() => {
        const fetchCategory = async () => {
            try {
                ...
                const necklaceCategory = categories.find(cat =>
                    cat.name.toLowerCase() === 'necklaces' || cat.slug === 'necklaces'
                );
                if (necklaceCategory) {
                    setCategoryId(necklaceCategory._id);
                }
            } catch (err) {
    ...
    return (
        <div className="min-h-screen bg-white font-serif">
            {/* Header */}
            <div className="relative overflow-hidden h-32 py-12 text-center" style={{
                ...
                <h1 className="relative text-4xl md:text-5xl text-white font-bold tracking-wide mt-[-20px] mb-2">Necklaces</h1>
                <p className="relative text-[#c9a84c] max-w-2xl mx-auto px-4 mt-[10px]">
                    Discover our collection of elegant necklaces, perfect for any occasion.
                </p>
            </div>
                ...
                {loading ? (
                    ...
                    <div className="flex flex-col items-center justify-center py-24 text-center">
                        <div className="bg-gray-900 border-l-4 border-avaya-gold p-12 shadow-2xl animate-in zoom-in duration-500 rounded-r-[3rem] max-w-xl">
                            ...
                            <p className="text-gray-400 font-sans mb-8">We are curating a breathtaking selection of necklaces. Stay tuned.</p>
