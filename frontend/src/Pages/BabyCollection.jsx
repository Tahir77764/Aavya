...
const BabyCollection = () => {
    ...
    useEffect(() => {
        const fetchProducts = async () => {
            try {
                // Fetching gender='Kids' as per model definition
                const { data } = await axios.get('/api/products?gender=Kids');
    ...
    return (
        <div className="min-h-screen bg-white font-serif">
            ...
            <div className="relative overflow-hidden bg-gray-50 h-32 py-12 text-center" style={{
                ...
                <h1 className="text-4xl md:text-5xl font-bold text-white tracking-wide mt-[-20px] mb-2">Baby Collection</h1>
                <p className="text-[#c9a84c] max-w-2xl mx-auto px-4 mt-[10px]">
                    Delicate and charming jewelry perfect for your little ones.
                </p>
            </div>
